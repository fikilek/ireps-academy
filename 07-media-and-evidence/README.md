...
- [Body of Knowledge placement guide](../01-body-of-knowledge/meter-discover-body-of-knowledge.md#placement-examples-context-and-closer-views): recognition cues, common confusions and sample comments alongside the images.

Actual field photographs remain a separate future collection requiring provenance and suitable usage permission. Existing video scripts have no verified finished recordings in this repository. See the [content index](../00-academy-governance/CONTENT_INDEX.md) and [owner decisions](../00-academy-governance/OWNER_DECISIONS.md).
