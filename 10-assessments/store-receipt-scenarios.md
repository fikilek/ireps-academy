# Store Check-in — Practical Examples and Assessment
...
[Body of Knowledge](../01-body-of-knowledge/store-receipt-body-of-knowledge.md) · [User Manual](../02-user-manual/shared/store-receipt-user-manual.md) · [Field catalogue](../01-body-of-knowledge/store-receipt-field-catalogue.md) · [Error register](../01-body-of-knowledge/store-receipt-error-register.md) · [Practical examples](store-receipt-scenarios.md)
...
**Expected answer:** Store Check-in records physical receipt of identified meters into a named store and transfers accountable custody. Separate the submitted record from any physical, credential, work or billing outcome it does not prove.
...
**Module focus:** Store/bin — Proposed; multi-store identity must be explicit.
