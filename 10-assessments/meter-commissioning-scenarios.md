# Meter Commissioning — Practical Examples and Assessment
...
[Body of Knowledge](../01-body-of-knowledge/meter-commissioning-body-of-knowledge.md) · [User Manual](../02-user-manual/mobile/meter-commissioning-user-manual.md) · [Field catalogue](../01-body-of-knowledge/meter-commissioning-field-catalogue.md) · [Error register](../01-body-of-knowledge/meter-commissioning-error-register.md) · [Practical examples](meter-commissioning-scenarios.md)
...
**Expected answer:** Meter Commissioning records the checks establishing whether an installed meter is ready for service. Recording the form and passing commissioning are different outcomes. Separate the submitted record from any physical, credential, work or billing outcome it does not prove.
...
**Module focus:** Vending confirmation — Required for prepaid electricity; yes needs vendingEvidence, no needs explanatory notes.
