# User Invitations — Practical Examples and Assessment
...
[Body of Knowledge](../01-body-of-knowledge/user-invitations-body-of-knowledge.md) · [User Manual](../02-user-manual/mobile/invite-a-user.md) · [Field catalogue](../01-body-of-knowledge/user-invitations-field-catalogue.md) · [Error register](../01-body-of-knowledge/user-invitations-error-register.md) · [Practical examples](user-invitations-scenarios.md)
...
**Expected answer:** User Invitations creates an account for a manager, supervisor or administrator through the authorised office workflow. Separate the submitted record from any physical, credential, work or billing outcome it does not prove.
...
**Module focus:** Name and surname — Required identity fields in the role-specific form.
