# Meter Disconnection — Practical Examples and Assessment
...
[Body of Knowledge](../01-body-of-knowledge/meter-disconnection-body-of-knowledge.md) · [User Manual](../02-user-manual/mobile/meter-disconnection-user-manual.md) · [Field catalogue](../01-body-of-knowledge/meter-disconnection-field-catalogue.md) · [Error register](../01-body-of-knowledge/meter-disconnection-error-register.md) · [Practical examples](meter-disconnection-scenarios.md)
...
**Expected answer:** Meter Disconnection records an authorised interruption of supply to an existing meter and the evidence of the completed action. Separate the submitted record from any physical, credential, work or billing outcome it does not prove.
...
**Module focus:** Instruction — Required; current local instruction list applies.
