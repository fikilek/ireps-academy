# Report Generation and Delivery — Practical Examples and Assessment
...
[Body of Knowledge](../01-body-of-knowledge/report-generation-body-of-knowledge.md) · [User Manual](../02-user-manual/web/report-generation-user-manual.md) · [Field catalogue](../01-body-of-knowledge/report-generation-field-catalogue.md) · [Error register](../01-body-of-knowledge/report-generation-error-register.md) · [Practical examples](report-generation-scenarios.md)
...
**Expected answer:** Report forms select reporting scope and, where implemented, generate or deliver a report derived from existing operational evidence. Separate the submitted record from any physical, credential, work or billing outcome it does not prove.
...
**Module focus:** Scope and dates — Confirm filters before generation; avoid comparing unlike periods.
