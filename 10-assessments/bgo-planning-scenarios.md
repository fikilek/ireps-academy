# BGO Planning — Practical Examples and Assessment
...
[Body of Knowledge](../01-body-of-knowledge/bgo-planning-body-of-knowledge.md) · [User Manual](../02-user-manual/web/bgo-planning-user-manual.md) · [Field catalogue](../01-body-of-knowledge/bgo-planning-field-catalogue.md) · [Error register](../01-body-of-knowledge/bgo-planning-error-register.md) · [Practical examples](bgo-planning-scenarios.md)
...
**Expected answer:** BGO planning creates and manages the batch work objects exposed by the current operational screens. Separate the submitted record from any physical, credential, work or billing outcome it does not prove.
...
**Module focus:** Source population — Check the specific BMD/TC route and source eligibility.
