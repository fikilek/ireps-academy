# Invited Profile and Admin Confirmation — Practical Examples and Assessment
...
[Body of Knowledge](../01-body-of-knowledge/invited-profile-body-of-knowledge.md) · [User Manual](../02-user-manual/shared/invited-profile-user-manual.md) · [Field catalogue](../01-body-of-knowledge/invited-profile-field-catalogue.md) · [Error register](../01-body-of-knowledge/invited-profile-error-register.md) · [Practical examples](invited-profile-scenarios.md)
...
**Expected answer:** Invitation completion lets an invited manager, supervisor or administrator replace their initial credential and supply the remaining profile information. Separate the submitted record from any physical, credential, work or billing outcome it does not prove.
...
**Module focus:** New permanent/admin password — Use the current authentication rule; verify older screen validation against it.
