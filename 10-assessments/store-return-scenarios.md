# Return to Store — Practical Examples and Assessment
...
[Body of Knowledge](../01-body-of-knowledge/store-return-body-of-knowledge.md) · [User Manual](../02-user-manual/shared/store-return-user-manual.md) · [Field catalogue](../01-body-of-knowledge/store-return-field-catalogue.md) · [Error register](../01-body-of-knowledge/store-return-error-register.md) · [Practical examples](store-return-scenarios.md)
...
**Expected answer:** Return to Store records accountable receipt of a meter coming back from field custody, removal or unused stock. Separate the submitted record from any physical, credential, work or billing outcome it does not prove.
...
**Module focus:** Return origin — Proposed; distinguish unused from removed meters.
