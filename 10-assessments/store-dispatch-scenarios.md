# Store Check-out — Practical Examples and Assessment
...
[Body of Knowledge](../01-body-of-knowledge/store-dispatch-body-of-knowledge.md) · [User Manual](../02-user-manual/shared/store-dispatch-user-manual.md) · [Field catalogue](../01-body-of-knowledge/store-dispatch-field-catalogue.md) · [Error register](../01-body-of-knowledge/store-dispatch-error-register.md) · [Practical examples](store-dispatch-scenarios.md)
...
**Expected answer:** Store Check-out transfers custody of specified stock to an installation service provider or another authorised recipient. Separate the submitted record from any physical, credential, work or billing outcome it does not prove.
...
**Module focus:** Store and recipient — Proposed; custody is distinct from employment role.
