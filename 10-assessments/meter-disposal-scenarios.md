# Meter Retirement and Disposal — Practical Examples and Assessment
...
[Body of Knowledge](../01-body-of-knowledge/meter-disposal-body-of-knowledge.md) · [User Manual](../02-user-manual/shared/meter-disposal-user-manual.md) · [Field catalogue](../01-body-of-knowledge/meter-disposal-field-catalogue.md) · [Error register](../01-body-of-knowledge/meter-disposal-error-register.md) · [Practical examples](meter-disposal-scenarios.md)
...
**Expected answer:** Retirement records the decision to end operational use; disposal records the authorised final handling of that physical meter. Separate the submitted record from any physical, credential, work or billing outcome it does not prove.
...
**Module focus:** Retirement decision — Proposed; distinct from removal and store return.
