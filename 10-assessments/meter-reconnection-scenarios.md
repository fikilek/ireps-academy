# Meter Reconnection — Practical Examples and Assessment
...
**Expected answer:** Meter Reconnection records restoration of supply to an existing disconnected meter, together with confirmation and proof. Separate the submitted record from any physical, credential, work or billing outcome it does not prove.
...
**Module focus:** Instruction — Required; canonical wording Reconnect meter.
