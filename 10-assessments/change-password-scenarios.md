# Change Password — Practical Examples and Assessment
...
[Body of Knowledge](../01-body-of-knowledge/change-password-body-of-knowledge.md) · [User Manual](../02-user-manual/shared/change-password.md) · [Field catalogue](../01-body-of-knowledge/change-password-field-catalogue.md) · [Error register](../01-body-of-knowledge/change-password-error-register.md) · [Practical examples](change-password-scenarios.md)
...
**Expected answer:** Change Password replaces a credential while a person has an authenticated session. The mandatory onboarding gate requires a successful password change before access continues. Separate the submitted record from any physical, credential, work or billing outcome it does not prove.
...
**Module focus:** New password — At least 8 characters under AU-R001; current session may need fresh sign-in.
