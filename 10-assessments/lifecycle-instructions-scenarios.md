# Lifecycle Instruction Creation — Practical Examples and Assessment
...
**Expected answer:** A lifecycle instruction requests a specific action on an existing meter and assigns responsibility before execution. Separate the submitted record from any physical, credential, work or billing outcome it does not prove.
...
**Module focus:** Transaction type — Only supported office instruction types; vending is not one of them.
