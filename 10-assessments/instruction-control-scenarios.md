# Lifecycle Instruction Control — Practical Examples and Assessment
...
[Body of Knowledge](../01-body-of-knowledge/instruction-control-body-of-knowledge.md) · [User Manual](../02-user-manual/mobile/instruction-control-user-manual.md) · [Field catalogue](../01-body-of-knowledge/instruction-control-field-catalogue.md) · [Error register](../01-body-of-knowledge/instruction-control-error-register.md) · [Practical examples](instruction-control-scenarios.md)
...
**Expected answer:** Instruction Control manages an existing lifecycle work instruction, including reassignment and cancellation where permitted. Separate the submitted record from any physical, credential, work or billing outcome it does not prove.
...
**Module focus:** Instruction — Must be in a state that permits the action.
