# Meter Procurement — Practical Examples and Assessment
...
[Body of Knowledge](../01-body-of-knowledge/meter-procurement-body-of-knowledge.md) · [User Manual](../02-user-manual/shared/meter-procurement-user-manual.md) · [Field catalogue](../01-body-of-knowledge/meter-procurement-field-catalogue.md) · [Error register](../01-body-of-knowledge/meter-procurement-error-register.md) · [Practical examples](meter-procurement-scenarios.md)
...
**Expected answer:** Procurement establishes the planned purchase and traceable acquisition of meters before operational use. Separate the submitted record from any physical, credential, work or billing outcome it does not prove.
...
**Module focus:** Purchase order — Proposed requirement; approval policy and numbering need agreement.
