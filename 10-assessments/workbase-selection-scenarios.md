# Workbase Selection and Account Settings — Practical Examples and Assessment
...
[Body of Knowledge](../01-body-of-knowledge/workbase-selection-body-of-knowledge.md) · [User Manual](../02-user-manual/shared/workbase-selection-user-manual.md) · [Field catalogue](../01-body-of-knowledge/workbase-selection-field-catalogue.md) · [Error register](../01-body-of-knowledge/workbase-selection-error-register.md) · [Practical examples](workbase-selection-scenarios.md)
...
**Expected answer:** A workbase scopes the person’s operational context. Selecting one chooses among assignments already available to that identity. Separate the submitted record from any physical, credential, work or billing outcome it does not prove.
...
**Module focus:** Workbase — Use an offered authorised reference; do not infer access from a place name.
