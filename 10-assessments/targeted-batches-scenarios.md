# Targeted Batch Planning and Allocation — Practical Examples and Assessment
...
[Body of Knowledge](../01-body-of-knowledge/targeted-batches-body-of-knowledge.md) · [User Manual](../02-user-manual/web/targeted-batches-user-manual.md) · [Field catalogue](../01-body-of-knowledge/targeted-batches-field-catalogue.md) · [Error register](../01-body-of-knowledge/targeted-batches-error-register.md) · [Practical examples](targeted-batches-scenarios.md)
...
**Expected answer:** Targeted batches group selected records into accountable fieldwork and assign them to eligible people or teams. Separate the submitted record from any physical, credential, work or billing outcome it does not prove.
...
**Module focus:** Source/upload — Validate format and context; do not treat an uploaded row as a discovered meter.
