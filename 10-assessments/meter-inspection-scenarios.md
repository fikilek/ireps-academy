# Meter Inspection — Practical Examples and Assessment
...
[Body of Knowledge](../01-body-of-knowledge/meter-inspection-body-of-knowledge.md) · [User Manual](../02-user-manual/mobile/meter-inspection-user-manual.md) · [Field catalogue](../01-body-of-knowledge/meter-inspection-field-catalogue.md) · [Error register](../01-body-of-knowledge/meter-inspection-error-register.md) · [Practical examples](meter-inspection-scenarios.md)
...
**Expected answer:** Meter Inspection records the meter as found, compares it with the existing iREPS asset information and records anomalies, evidence and permitted follow-on work. Separate the submitted record from any physical, credential, work or billing outcome it does not prove.
...
**Module focus:** Captured asset values — Service-specific fields and confirmed comparison govern changes.
