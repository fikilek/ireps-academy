...
| DEC-020 | Canonical module name | Confirmed owner direction, 24 September 2026 | Use **Meter Discovery** for the module, Body of Knowledge, User Manual and supporting Academy references. This supersedes the earlier module-name wording in DEC-016. Existing document URLs and technical identifiers remain stable. |
