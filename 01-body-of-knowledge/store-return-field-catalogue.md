# Return to Store — Field Catalogue
...
| --- | --- | --- | --- | --- |
| Return origin | Reference | Dispatch/removal explaining the return. | Proposed; distinguish unused from removed meters. | TRAIN-REM01 |
| Condition/disposition | Assessment | Proposed next handling of the returned unit. | Review required; return does not prove fitness for reuse. | Assessment pending |
| Receipt and custodian | References/timestamps | Handover from field to store. | Both parties and physical destination need agreement. | TRAIN-RET01 |
